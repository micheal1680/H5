...
（这是常问到的关于webpack的面试题，以上两点就是他们的区别）
...
【loader用于识别文件；（loader需要安装与配置）
plugin用于处理文件（plugin需要安装、插入与配置）】
...
2. css：文件合并，CDN分布式服务器，样式选择器预先写好；

3. js：dom操作合并，尽量避免dom操作放到for循环里面，避免重绘和重排

   （具体如何操作去看网盘里的：”webpack面试题复习“视频）

 补充：自动化工具webpack插件也可以做优化
