...
import UserAdderss from "../components/about/UserAdderss.vue";
//路由懒加载
const things = () => import("../components/things/things.vue");
...
const myrouter = [{
	...
	},
	{
		...
		children:[{
			path:"all",
			component:(resolve)=>require(["../components/things/allThings.vue"],resolve)
		},
		{
			path:"completed",
			component:(resolve)=>require(["../components/things/completedThings.vue"],resolve)//
		},
		{
			path:"uncomplete",
			component:(resolve)=>require(["../components/things/uncompleteThings.vue"],resolve)
		}],
		meta: {
			// 7、路由元信息
			//(1)添加元信息-------------router.js
